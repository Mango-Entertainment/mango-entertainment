...
const Navbar = () => {
  ...
  return (
    <div className="grid grid-cols-3 h-20 lg:grid-cols-1 lg:h-screen lg:grid-rows-[3fr_3fr_9fr] lg:place-items-start bg-entertainment-semi-dark-blue items-center md:mx-6 md:w-auto md:mt-6 md:rounded-xl lg:max-h-[960px] sticky w-full lg:mx-0 lg:justify-self-center lg:w-20">
